...
#===============================================================================
# Intelligente Item-Erkennung und Nutzung
#
# Kategorien:
...
module AdvancedAI
  module ItemIntelligence
    ...
    # Berechnet Item-Damage-Multiplier
    ...
    # Prüft ob Pokemon Choice-locked ist
    ...
    def self.get_item_threat_modifier(battler)
      ...
      # Choice Items = +1.0 threat (locked aber powerful)
      ...
      # Weakness Policy = +0.5 threat (kann gefährlich werden)
      modifier += 0.5 if item == :WEAKNESSPOLICY
      
      # Focus Sash = -0.3 threat (überlebt 1 hit)
      modifier -= 0.3 if item == :FOCUSSASH
      
      # Heavy-Duty Boots = -0.2 threat (ignoriert Hazards)
    ...
    # Empfiehlt bestes Item für Pokemon-Rolle
