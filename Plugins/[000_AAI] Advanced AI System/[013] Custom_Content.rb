...
#===============================================================================
# Erkennt und bewertet 267+ Abilities aus Gen 1-9
# Unterstützt Custom Abilities aus Plugins (DBK, Reborn, etc.)
#
# Kategorien:
...
module AdvancedAI
  module CustomContent
    ...
    #===========================================================================
    # Offensive Abilities (erhöhen Bedrohung massiv)
    #===========================================================================
    OFFENSIVE_ABILITIES = {
    ...
    #===========================================================================
    # Defensive Abilities (senken Bedrohung / erhöhen Survival)
    #===========================================================================
    DEFENSIVE_ABILITIES = {
    ...
    #===========================================================================
    # Speed Abilities (erhöhen Initiative-Bedrohung)
    #===========================================================================
    SPEED_ABILITIES = {
    ...
    #===========================================================================
    # Support Abilities (erhöhen Team-Utility)
    #===========================================================================
    SUPPORT_ABILITIES = {
    ...
    # Gibt Threat-Modifier für Ability zurück
    ...
    # Prüft ob Ability Speed boosted
    ...
    # Prüft ob Ability Support-Funktion hat
    ...
    # Prüft ob Ability von aktuellem Wetter profitiert
    ...
    # Prüft ob Ability von aktivem Terrain profitiert
    def self.benefits_from_terrain?(battler, terrain)
      ...
      when :Psychic
        return false  # Keine direkten Ability-Synergien
      when :Misty
        return false  # Keine direkten Ability-Synergien
      end
    ...
    # Prüft ob Attacker Abilities ignoriert
    ...
    # Prüft ob Target-Ability durch Attacker ignoriert wird
    ...
    # Berechnet finalen Damage Modifier durch Abilities
    def self.calculate_ability_damage_modifier(attacker, target, move, battle)
      ...
      if attacker_ability && !ability_suppressed?(target, attacker)
        ...
        when :TECHNICIAN
          modifier *= 1.5 if move.base_damage <= 60
        when :IRONFIST
